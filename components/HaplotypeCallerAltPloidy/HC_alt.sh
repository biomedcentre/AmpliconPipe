...
gatk HaplotypeCaller -R "${AMPLICON_REF}" -I "${INPUT_BAM}" -O "${output}".haplotype.caller.altploidy.vcf.gz --native-pair-hmm-threads "${THREADS}" -ploidy "${PLOIDY}" --verbosity WARNING
