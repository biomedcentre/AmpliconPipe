...
python3 gen_reads.py -r /pipeline/output/"${PSEUDO_COORDS}".temp.pseudo_seq.fasta -R 150 -o /pipeline/output/"${PSEUDO_COORDS}".temp.pseudo -c 100 --pe 150 30 -M 0 --rng 42 -E 0
